...
import { getQuery, allQuery, executeQuery, beginTransaction, commitTransaction, rollbackTransaction, smartUpdate } from '@/lib/db-adapter'
  ...
  try {
    ...
    try {
      ...
      await smartUpdate('reports', 
        { status, reviewer_id: authResult.user.id, resolution: resolution || null, resolved_at: now }, 
        'id = $1', 
        [reportId]
      )
