...
export default function TermsOfServicePage({ params }: { params: { locale: string } }) {
  ...
  const content = staticPagesContent.legal.termsOfService[locale as keyof typeof staticPagesContent.legal.termsOfService] 
    || staticPagesContent.legal.termsOfService.en;
